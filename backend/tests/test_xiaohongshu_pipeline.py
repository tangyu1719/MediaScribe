...
def test_video_pipeline_routes_xhs_without_get_task_name_error():
    async def _run() -> None:
        ...
        with patch("app.services.video_pipeline._is_xiaohongshu_graphic_sync", return_value=True):
                        ...
                        with patch(
                            ...
                            with patch("app.services.xiaohongshu_article.resolve_doc_title", return_value="文档标题"):
                                with patch(
                                    ...
                                    with patch("app.services.xiaohongshu_article._feishu_upload", return_value={"ok": False, "skipped": True}):
