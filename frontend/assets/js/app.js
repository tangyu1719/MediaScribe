...
const sbFootCollapsed=ref((()=>{try{return localStorage.getItem("sba_sb_foot_collapsed")==="1"}catch(_){return false}})());
function toggleSbFoot(){
  sbFootCollapsed.value=!sbFootCollapsed.value;
  try{localStorage.setItem("sba_sb_foot_collapsed",sbFootCollapsed.value?"1":"0")}catch(_){}
}
const sub=reactive({
